...
export default function HeroSection({ name, role, side }) {
  ...
  return (
    <section ref={sectionRef} className="relative w-full h-screen overflow-hidden flex flex-col md:flex-row bg-transparent">
      ...
      <div className="relative md:w-1/5 w-full py-12 md:py-0 md:h-full z-20 flex flex-col items-center justify-center md:border-l border-[#D4AF37]/30 bg-[#FFF8DC]/60 backdrop-blur-xl md:backdrop-blur-md">
        
        {/* Tên Cô Dâu Chú Rể */}
        <div className="text-center px-4 mb-8">
          <p className="text-xs md:text-[10px] lg:text-xs tracking-[0.2em] uppercase mb-4 opacity-90 font-semibold text-[#7a1f24]">
            Tân Lang & Tân Nương
          </p>
          
          <h1 className="text-6xl md:text-5xl lg:text-6xl font-calligraphy text-[#7a1f24] leading-[1.2] flex flex-col items-center">
            <span>{leftName}</span>
