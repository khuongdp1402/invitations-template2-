...
export default function InvitationWords() {
  ...
  return (
    <section ref={containerRef} className="py-24 px-4 bg-[#F9F6F0] relative z-10 overflow-hidden">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center gap-12 md:gap-8">
        ...
        <div className="invitation-item w-full md:w-1/3 text-center px-4">
          <div className="text-[#8B1C1C] mb-6">
          ...
          <p className="text-gray-700 font-serif text-lg md:text-xl leading-relaxed mb-6">
            quý khách tới dự buổi tiệc chung vui cùng gia đình chúng tôi.
          </p>
          <p className="text-gray-600 font-serif leading-relaxed">
            Sự hiện diện của <strong className="font-semibold text-gray-800">quý khách</strong> là niềm vinh hạnh lớn lao cho gia đình chúng tôi.
          </p>
