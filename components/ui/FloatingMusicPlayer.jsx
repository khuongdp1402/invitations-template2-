...
export default function FloatingMusicPlayer() {
  ...
  return (
    <>
      ...
      <button 
        onClick={togglePlay}
        className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-white rounded-full shadow-2xl flex items-center justify-center border-4 border-[#C5A059] focus:outline-none hover:scale-105 transition-transform"
      ...
      >
        ...
        {isPlaying && (
          <div className="absolute -top-4 -right-2 text-[#8B1C1C] animate-bounce">
